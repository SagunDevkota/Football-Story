...
//            Objects.requireNonNull(getSupportActionBar()).show();
    ...
    private void orientation(){
        if(fullScreen){
            getWindow().clearFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED);
            Toast.makeText(LiveStreamPlayer.this, "Full Screen Off", Toast.LENGTH_SHORT).show();
            fullScreen = false;
        }else {
            getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
            Toast.makeText(LiveStreamPlayer.this, "Full Screen", Toast.LENGTH_SHORT).show();
            fullScreen = true;
        }
    }
    private void getM3u8() {
        objRunnable = () -> {
            Looper.prepare();
            APIConnect apiConnect = new APIConnect(LiveStreamPlayer.this);
    ...
    Handler objHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            try {
                ...
                TrackSelector trackSelector = new DefaultTrackSelector(LiveStreamPlayer.this);
                simpleExoPlayer = new SimpleExoPlayer.Builder(LiveStreamPlayer.this).setMediaSourceFactory(
                        new DefaultMediaSourceFactory(LiveStreamPlayer.this)).setTrackSelector(trackSelector)
                        .build();
                ...
                simpleExoPlayer.addListener(new Player.EventListener() {
                    ...
                    public void onPlayerError(@NonNull ExoPlaybackException error)
                    {
                        if(error.type == ExoPlaybackException.TYPE_SOURCE){
                            Toast.makeText(LiveStreamPlayer.this,"Server Not Responding",Toast.LENGTH_LONG).show();
                        }
//                        simpleExoPlayer.stop(true);
                ...
                Toast.makeText(LiveStreamPlayer.this, "Error", Toast.LENGTH_SHORT).show();
            }
        }
    };
